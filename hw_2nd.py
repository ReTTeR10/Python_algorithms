...
'''
p.s. Заметил что не совсем верно решил эту задачу, но исправить ее, к сожалению, не было времени совершенно,
ровно как и в целом это дз может оставить у вас несколько "халтурное" впечатление. У меня на след неделе готовится
командировка на КГО (Кавказская Горная Обсерватория). И всю эту неделю занимался наладкой нового телескопа (ПО для 
приемника излучения, колеса с фильтрами, монтировки(куда установлен телескоп), проверкой всех систем (естественно по ночам)) 
И вот телескоп на след неделе и повезем. Поэтому, прошу прощения за такое дз.
'''